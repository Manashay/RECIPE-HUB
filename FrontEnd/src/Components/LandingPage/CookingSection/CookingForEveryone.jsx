...
const YumYard = () => {
  const assets = {
    ...
    chefIcon: "https://cdn.jsdelivr.net/gh/Tarikul-Islam-Anik/Animated-Fluent-Emojis/Emojis/Food/Pizza.png",
            ...
            <div className="content-container">
              ...
              <div className="feature-list">
                ...
                <div className="feature-card">
                  ...
                  <p className="feature-text">
                    Have fun exploring diverse meal types with interactive guides for over 1 million unique dishes
                  </p>
                </div>
              </div>
            </div>
