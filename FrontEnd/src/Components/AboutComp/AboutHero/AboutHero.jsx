...
const AboutHero = () => {
  const assets = {
    saladPlate: "https://images.unsplash.com/photo-1512621776951-a57141f2eefd?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
    ...
    onion: "https://cdn.jsdelivr.net/gh/Tarikul-Islam-Anik/Animated-Fluent-Emojis/Emojis/Food/Onion.png"
  };
        ...
        <div className="about-hero-wrapper">
          ...
          <div className="hero-plate-area">
            ...
            <img 
              ...
              style={{ top: '10%', right: '-20px', width: '100px', '--rotate': '25deg', animationDelay: '0s' }} 
              alt="Avocado" 
            />
            <img 
              src={assets.lemon} 
              className="hero-floating-item"
              style={{ top: '-10%', right: '250px', width: '70px', '--rotate': '-15deg', animationDelay: '1s' }} 
              alt="Lemon" 
            />
            <img 
              src={assets.onion} 
              className="hero-floating-item"
              style={{ top: '25%', right: '380px', width: '60px', '--rotate': '45deg', animationDelay: '0.5s' }} 
              alt="Onion" 
            />
            <img 
              src={assets.leaf} 
              className="hero-floating-item"
              style={{ top: '75%', right: '380px', width: '80px', '--rotate': '-30deg', animationDelay: '1.5s' }} 
              alt="Leaf" 
            />
          </div>
